...
from tinygrad.helpers import CPU_LLVM, CPU_LVP, NV_PTX, CUDA_PTX, NV_NAK, CUDA_CC, NV_CC, CPU_CC
...
def is_dtype_supported(dtype:DType, device:str|None=None) -> bool:
  ...
  cpu_llvm = CPU_CC.value=="LLVM" if CPU_CC is not None else CPU_LLVM
